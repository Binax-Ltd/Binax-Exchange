# CHANGELOG for Binax's API (2018-11-13)
## 2018-11-13
### Rest API
...
#### Explanation for the average price calculation:
  ...
  4. The current average price can be checked here: `https://api.binax.io/api/v3/avgPrice?symbol=<symbol>`
     For example:
     https://api.binax.io/api/v3/avgPrice?symbol=BNBUSDT
